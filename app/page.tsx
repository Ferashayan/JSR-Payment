    ...
    <div className="w-full max-w-[1600px] mx-auto flex gap-gutter items-stretch">
      ...
      <div className="grow glass-panel rounded-2xl p-xl flex flex-col relative overflow-hidden glow-effect">
        ...
        <div className="flex justify-between items-center mb-xl relative z-10">
          ...
          <button className="glass-panel px-md py-sm rounded-lg font-label-md text-white hover:bg-white/10 transition flex items-center gap-2"><span className="material-symbols-outlined text-[18px]">download</span>تصدير التقرير</button>
        </div>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-md mb-lg relative z-10">
          <div onClick={() => openModal('net_salary')} className="glass-panel rounded-xl p-md flex flex-col gap-3 cursor-pointer hover:bg-white/10 transition-all hover:-translate-y-1 group">
            ...
            <div><h3 className="font-label-sm text-outline-variant mb-1">صافي الرواتب</h3><div className="font-h3 text-white flex gap-1 items-baseline">1,540,200 <span className="font-label-sm text-outline-variant">ر.س</span></div></div>
          </div>
          <div onClick={() => openModal('bonuses')} className="glass-panel rounded-xl p-md flex flex-col gap-3 cursor-pointer hover:bg-white/10 transition-all hover:-translate-y-1 group">
            ...
            <div><h3 className="font-label-sm text-outline-variant mb-1">البدلات والمكافآت</h3><div className="font-h3 text-white flex gap-1 items-baseline">250,500 <span className="font-label-sm text-outline-variant">ر.س</span></div></div>
          </div>
          <div onClick={() => openModal('deductions')} className="glass-panel rounded-xl p-md flex flex-col gap-3 cursor-pointer hover:bg-white/10 transition-all hover:-translate-y-1 group">
            ...
            <div><h3 className="font-label-sm text-outline-variant mb-1">الاستقطاعات</h3><div className="font-h3 text-white flex gap-1 items-baseline">124,500 <span className="font-label-sm text-outline-variant">ر.س</span></div></div>
          </div>
          <div onClick={() => openModal('overtime')} className="glass-panel rounded-xl p-md flex flex-col gap-3 cursor-pointer hover:bg-white/10 transition-all hover:-translate-y-1 group">
            ...
            <div><h3 className="font-label-sm text-outline-variant mb-1">العمل الإضافي</h3><div className="font-h3 text-white flex gap-1 items-baseline">74,000 <span className="font-label-sm text-outline-variant">ر.س</span></div></div>
          </div>
        </div>
        <div className="grid grid-cols-3 gap-lg grow relative z-10">
          <div onClick={() => openModal('total_salaries')} className="col-span-2 glass-panel rounded-xl p-md flex flex-col justify-between cursor-pointer hover:bg-white/5 transition-colors group">
            ...
            <div className="grow flex items-end gap-2 pb-sm relative">
              <div className="absolute right-0 top-0 bottom-8 w-10 flex flex-col justify-between text-outline-variant font-data-tabular text-[10px]"><span>2M</span><span>1M</span><span>0</span></div>
              <div className="w-full flex items-end justify-between pl-12 h-full">
                <div className="w-1/6 bg-white/10 rounded-t-sm h-[30%] hover:bg-white/20 transition-all cursor-pointer relative group/bar"><div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black/80 text-white font-label-sm px-2 py-1 rounded opacity-0 group-hover/bar:opacity-100 transition pointer-events-none">1.2M</div></div>
                <div className="w-1/6 bg-white/10 rounded-t-sm h-[45%] hover:bg-white/20 transition-all cursor-pointer relative group/bar"><div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black/80 text-white font-label-sm px-2 py-1 rounded opacity-0 group-hover/bar:opacity-100 transition pointer-events-none">1.4M</div></div>
                <div className="w-1/6 bg-white/10 rounded-t-sm h-[60%] hover:bg-white/20 transition-all cursor-pointer relative group/bar"><div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black/80 text-white font-label-sm px-2 py-1 rounded opacity-0 group-hover/bar:opacity-100 transition pointer-events-none">1.6M</div></div>
                <div className="w-1/6 bg-secondary-container/60 rounded-t-sm h-[85%] hover:bg-secondary-container/80 transition-all cursor-pointer relative group/bar shadow-[0_0_15px_rgba(108,248,187,0.3)]"><div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black/80 text-secondary-container font-label-sm px-2 py-1 rounded opacity-0 group-hover/bar:opacity-100 transition pointer-events-none border border-secondary-container/30">1.9M</div></div>
                <div className="w-1/6 bg-white/10 rounded-t-sm h-[50%] hover:bg-white/20 transition-all cursor-pointer relative group/bar"><div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-black/80 text-white font-label-sm px-2 py-1 rounded opacity-0 group-hover/bar:opacity-100 transition pointer-events-none">1.5M</div></div>
              </div>
              <div className="absolute bottom-0 right-12 w-[calc(100%-3rem)] flex justify-between text-outline-variant font-data-tabular text-[10px]"><span>يونيو</span><span>يوليو</span><span>أغسطس</span><span className="text-secondary-container">سبتمبر</span><span>أكتوبر</span></div>
            </div>
          </div>
          <div className="col-span-1 flex flex-col gap-md">
            <div onClick={() => openModal('active_employees')} className="glass-panel rounded-xl p-md grow flex flex-col justify-center items-center text-center cursor-pointer hover:bg-white/5 transition-colors group">
              <div className="w-24 h-24 rounded-full border-4 border-secondary-container/30 border-t-secondary-container flex items-center justify-center mb-sm relative"><span className="font-h2 text-white glow-text">142</span><div className="absolute inset-0 rounded-full border border-secondary-container/50 animate-ping opacity-20"></div></div>
