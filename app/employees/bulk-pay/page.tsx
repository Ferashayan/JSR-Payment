    ...
    <div className="w-full max-w-[1600px] mx-auto flex gap-gutter items-stretch">
      <div className="hidden lg:flex flex-col gap-gutter w-72 shrink-0 z-20 relative">
        ...
        <div className="glass-panel rounded-xl p-md flex flex-col flex-1 relative overflow-hidden">
          ...
          <div className="flex flex-col gap-3 relative z-10">
            ...
            <button className="w-full mt-2 py-2 rounded-lg bg-secondary-container/20 text-secondary-container font-label-sm hover:bg-secondary-container/30 transition border border-secondary-container/30">محاكاة التحويل</button>
          </div>
        </div>
      </div>
      <div className="grow glass-panel rounded-2xl p-xl flex flex-col relative overflow-hidden glow-effect">
        ...
        <div className="grow flex flex-col gap-6 relative z-10">
          <div className="w-full border-2 border-dashed border-white/20 rounded-2xl p-10 flex flex-col items-center justify-center bg-white/2 hover:bg-white/5 hover:border-secondary-container/50 transition-all cursor-pointer group">
          ...
          <div className="bg-white/5 rounded-2xl border border-white/10 flex flex-col grow overflow-hidden shadow-sm">
            <div className="p-4 border-b border-white/10 flex justify-between items-center bg-white/2">
              ...
              <button className="px-4 py-2 rounded-lg bg-secondary-container text-on-secondary-container font-label-sm flex items-center gap-2 hover:bg-secondary-fixed transition"><span className="material-symbols-outlined text-[18px]">fact_check</span>بدء التحويل</button>
            </div>
            <div className="overflow-x-auto">
              <table className="w-full text-right border-collapse">
                <thead className="bg-white/2 border-b border-white/10 font-label-sm text-outline-variant"><tr><th className="px-6 py-4 font-medium">اسم الموظف</th><th className="px-6 py-4 font-medium">الدولة</th><th className="px-6 py-4 font-medium">المبلغ المستحق</th><th className="px-6 py-4 font-medium">وسيلة الدفع</th><th className="px-6 py-4 font-medium text-left">التحقق</th></tr></thead>
                <tbody className="font-body-sm text-white divide-y divide-white/5">
                  <tr className="hover:bg-white/5 transition-colors"><td className="px-6 py-4 font-medium">أحمد سالم</td><td className="px-6 py-4"><span className="flex items-center gap-2">🇸🇦 السعودية</span></td><td className="px-6 py-4 font-data-tabular">24,500 <span className="text-xs text-outline-variant">ر.س</span></td><td className="px-6 py-4 text-outline-variant">تحويل بنكي مباشر</td><td className="px-6 py-4 text-left"><span className="material-symbols-outlined text-secondary-container">check_circle</span></td></tr>
                  <tr className="hover:bg-white/5 transition-colors"><td className="px-6 py-4 font-medium">جون ميلر</td><td className="px-6 py-4"><span className="flex items-center gap-2">🇺🇸 الولايات المتحدة</span></td><td className="px-6 py-4 font-data-tabular">31,200 <span className="text-xs text-outline-variant">ر.س</span></td><td className="px-6 py-4 text-outline-variant">USD Wallet</td><td className="px-6 py-4 text-left"><span className="material-symbols-outlined text-secondary-container">check_circle</span></td></tr>
                  <tr className="hover:bg-white/5 transition-colors bg-error-container/5"><td className="px-6 py-4 font-medium">كريم حسن</td><td className="px-6 py-4"><span className="flex items-center gap-2">🇪🇬 مصر</span></td><td className="px-6 py-4 font-data-tabular">15,400 <span className="text-xs text-outline-variant">ر.س</span></td><td className="px-6 py-4 text-error-container">رقم حساب غير صالح</td><td className="px-6 py-4 text-left"><span className="material-symbols-outlined text-error">cancel</span></td></tr>
                  <tr className="hover:bg-white/5 transition-colors"><td className="px-6 py-4 font-medium">سارة جونسون</td><td className="px-6 py-4"><span className="flex items-center gap-2">🇬🇧 المملكة المتحدة</span></td><td className="px-6 py-4 font-data-tabular">28,900 <span className="text-xs text-outline-variant">ر.س</span></td><td className="px-6 py-4 text-outline-variant">GBP Wallet</td><td className="px-6 py-4 text-left"><span className="material-symbols-outlined text-secondary-container">check_circle</span></td></tr>
                </tbody>
              </table>
            </div>
          </div>
